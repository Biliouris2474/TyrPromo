const BookBlurb = () => {
 ...
 <article>
    ...
    <div className="book">
        <img src="../assets/images/bookgal/TBook1.jpg" alt="Book One"/>
        <h2>Tyrannophis</h2>
            <br/>
    ...
    <div className="book">
        <img src="../assets/images/bookgal/TBook2.jpg" alt="Book Two"/>
    ...
    <div className="book">
        <img src="../assets/images/bookgal/TBook3.jpg" alt="Book Three"/>
